...
const (
	...
	FileService_ListFiles_FullMethodName    = "/api.FileService/ListFiles"
	FileService_DownloadFile_FullMethodName = "/api.FileService/DownloadFile"
)
